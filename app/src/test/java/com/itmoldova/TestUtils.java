...
public class TestUtils {
    ...
    public static List<Item> tenArticles(){
        List<Item> items = new ArrayList<>();
        items.addAll(sixArticles());

        Item item1 = new Item();
        item1.setPubDate("Wed, 07 Jan 2018 05:05:10 +0000");
        item1.setGuid("7");
        items.add(item1);

        Item item2 = new Item();
        item2.setPubDate("Mon, 07 Jan 2018 08:08:19 +0000");
        item2.setGuid("8");
        items.add(item2);

        Item item3 = new Item();
        item3.setPubDate("Mon, 07 Jan 2018 08:05:19 +0000");
        item3.setGuid("9");
        items.add(item3);

        Item item4 = new Item();
        item4.setPubDate("Fri, 07 Dec 2018 06:35:32 +0000");
        item4.setGuid("10");
        items.add(item4);
